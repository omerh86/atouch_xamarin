...
namespace Linphone
{
    ...
    /// <summary>
    /// The LinphoneInfoMessage is an object representing an informational message sent
    ...
    public class Call : LinphoneObject
    {
        ...
        /// <summary>
        /// When receiving a  state notification, prevent LinphoneCore from performing an
        /// automatic answer. 
        /// </summary>
    ...
    /// <summary>
    /// The LinphoneXmlRpcSession object used to send XML-RPC requests and handle their
    /// responses. 
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    public class Core : LinphoneObject
    {
        ...
        /// <summary>
        /// Add a friend to the current buddy list, if  is set, a SIP SUBSCRIBE message is
        /// sent. 
        /// </summary>
        ...
        /// <summary>
        /// Create a LinphoneCallParams suitable for <see
        ...
        /// LinphoneAddress can be constructed directly using , or created by <see
        /// cref="Linphone.Core.InterpretUrl()" />. 
        /// </summary>
        ...
        /// <summary>
        /// Sets the user agent string used in SIP messages, ideally called just after  or
        /// linphone_core_init(). 
        /// </summary>
    ...
    public class FriendList : LinphoneObject
    {
        ...
        /// <summary>
        /// Creates and adds LinphoneFriend objects to LinphoneFriendList from a file that
    ...
    public class Address : LinphoneObject
    {
        ...
        [DllImport(LinphoneWrapper.LIB_NAME)]
        static extern char linphone_address_equal(IntPtr thiz, IntPtr a2);
        ...
        {
            return linphone_address_equal(nativePtr, a2 != null ? a2.nativePtr : IntPtr.Zero) == (char)0 ? false : true;
        }
        [DllImport(LinphoneWrapper.LIB_NAME)]
        static extern IntPtr linphone_address_get_header(IntPtr thiz, string name);
        ...
        public string GetHeader(string name)
        {
            IntPtr stringPtr = linphone_address_get_header(nativePtr, name);
            return Marshal.PtrToStringAnsi(stringPtr);
        }
        [DllImport(LinphoneWrapper.LIB_NAME)]
        ...
        [DllImport(LinphoneWrapper.LIB_NAME)]
        static extern char linphone_address_weak_equal(IntPtr thiz, IntPtr a2);
        ...
        {
            return linphone_address_weak_equal(nativePtr, a2 != null ? a2.nativePtr : IntPtr.Zero) == (char)0 ? false : true;
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// Class to store tunnel settings. 
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    public class ChatRoom : LinphoneObject
    {
        ...
        /// <summary>
        /// When realtime text is enabled ,  is call everytime a char is received from
        /// peer. 
        /// </summary>
        public uint Char
        {
        ...
        /// <summary>
        /// get peer address  this <see cref="Linphone.ChatRoom" /> 
        /// </summary>
        ...
        [DllImport(LinphoneWrapper.LIB_NAME)]
        static extern IntPtr linphone_chat_room_create_message_2(IntPtr thiz, string message, string externalBodyUrl, int state, long time, char isRead, char isIncoming);
        ...
        {
            IntPtr ptr = linphone_chat_room_create_message_2(nativePtr, message, externalBodyUrl, (int)state, time, isRead ? (char)1 : (char)0, isIncoming ? (char)1 : (char)0);
            return fromNativePtr<ChatMessage>(ptr, false);
        }
        [DllImport(LinphoneWrapper.LIB_NAME)]
    ...
    public class ChatMessage : LinphoneObject
    {
        ...
        [DllImport(LinphoneWrapper.LIB_NAME)]
        static extern int linphone_chat_message_set_text(IntPtr thiz, string text);
        ...
        public string Text
        {
            ...
            set
            {
                linphone_chat_message_set_text(nativePtr, value);
    ...
    public class VideoDefinition : LinphoneObject
    {
        ...
        /// <summary>
        /// Tells whether two LinphoneVideoDefinition objects are equal (the widths and the
    ...
    public class Friend : LinphoneObject
    {
        ...
        /// <summary>
        /// Contructor same as  + <see cref="Linphone.Friend.SetAddress()" /> 
        /// </summary>
